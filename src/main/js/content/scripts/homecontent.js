...
export function getDescription() {
    var description = "Welcome to my little showcase. The focus is on WebGL2, REACT, Bootstrap, Canvas (logo), Javascript development, " +                                "of my artistic endeavours. Some of the features include dynamic CSS overrides of Bootstrap themes, autonomous " +
