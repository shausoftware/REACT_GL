...
function pageCss(rgb) {
    ...
    css += '.navbar-default .navbar-nav > li > a.shau-particles:hover,.navbar-default .navbar-nav > li > a.shau-particles:focus {color:#0000FF;}';
    ...
    css += '.navbar-default .navbar-nav > li.active > a.shau-particles {background: black; color: #0000FF;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-particles:hover {background: black; color: #0000FF;}';
