...
function pageCss(rgb) {
    ...
    css += '.navbar-default .navbar-nav > li > a.shau-raymarching:hover,.navbar-default .navbar-nav > li > a.shau-raymarching:focus {color:#00FF00;}';
    css += '.navbar-default .navbar-nav > li > a.shau-experiments:hover,.navbar-default .navbar-nav > li > a.shau-experiments:focus {color:#0000FF;}';
    css += '.navbar-default .navbar-nav > li > a.shau-form:hover,.navbar-default .navbar-nav > li > a.shau-form:focus {color:#FF00FF;}';
    css += '.navbar-default .navbar-nav > li > a.shau-links:hover,.navbar-default .navbar-nav > li > a.shau-links:focus {color:#FFFFFF;}';
    ...
    css += '.navbar-default .navbar-nav > li.active > a.shau-raymarching {background: black; color: #00FF00;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-raymarching:hover {background: black; color: #00FF00;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-experiments {background: black; color: #0000FF;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-experiments:hover {background: black; color: #0000FF;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-form {background: black; color: #FF00FF;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-form:hover {background: black; color: #FF00FF;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-links {background: black; color: #FFFFFF;}';
    css += '.navbar-default .navbar-nav > li.active > a.shau-links:hover {background: black; color: #FFFFFF;}';
