...
export default class Particles extends React.Component {
    ...
    componentDidMount() {
        ...
        const bufferExt = ShauRMGL.checkExtensions(gl);
        if (!bufferExt) return;

        //vignette program
        const vvsSource = VertexShader.vertexSource();
        const vfsSource = VignetteFragmentShader.fragmentSource();
        const vignetteProgram = ShauRMGL.initShaderProgram(gl, vvsSource, vfsSource);
        ...
        const computeShaderProgram = ShauRMGL.initShaderProgram(gl, cvsSource, cfsSource);
        ...
        const initShaderProgram = ShauRMGL.initShaderProgram(gl, cvsSource, ifsSource);
        ...
        var vignetteBuffer = ShauRMGL.setupRenderFramebuffer(gl);
